/*
 * Kimboard — Auto-Lauschen am Nostr-Relais (Empfangsmodus mit Antwortrecht).
 *
 * Beim Öffnen initialisiert Kimboard die Anastomose (Modul 05) und beginnt
      ...
      .then(function () {
        if (typeof A.listenNostr === "function" && window.SbkimNostrRelay) {
          return A.listenNostr()
            .then(function () {
              console.info("[Kimboard] Auto-Lauschen aktiv (Empfangsmodus mit Antwortrecht).");
            ...
            .catch(function (e) { console.warn("[Kimboard] Auto-Lauschen übersprungen:", e); });
        }
      })
      .catch(function (e) { console.warn("[Kimboard] Andock-Init übersprungen (braucht Browser):", e); });
  }
